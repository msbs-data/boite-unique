...
function julianDayToUmalqura(intlUmalquraData, julianDay) {
  ...
  const {year: year, month: month, day: day} = intlUmalquraData.je(epochDaysToIsoDate(julianDay - unixEpochJulianDay));
  return {
    year: year,
    month: month,
    day: day
