...
declare function getInteractiveElement(element: Element): Element | null;
...
declare function scrollIntoViewIfNeeded(el: Element, { block, inline }?: ScrollIntoViewOptions): void;
